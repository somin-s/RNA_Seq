...
# min.cells is to show all features (genes) that express at lease in 3 cells
# min.features is to show all cells that have at lease 200 genes.
str(nsclc.seurat.obj) #what is slots??? -> might be the set of result after running program
nsclc.seurat.obj #
